...
# Maps from map_editor
from map_editor.map_PID import MyMapPID
from map_editor.map_test import MyMaptest

from solutions.my_drone_random import MyDroneRandom
from solutions.pid_my_drone_lateral import MyDronePID_lateral
from solutions.pid_my_drone_angle import MyDronePID_angle
from solutions.pid_my_drone_forward import MyDronePID_forward
from solutions.pid_my_drone import MyDronePID

class MyDrone(MyDronePID_forward):
    pass
...
class Launcher:
    ...
    def __init__(self):
        ...
        eval_config = EvalConfig(map_type=MyMapPID, nb_rounds=1)
