...
class MyDroneFrontex(DroneAbstract):
    ...
    def go_to_waypoint(self, x, y):
        ...
        epsilon = normalize_angle(epsilon)
        command_path = self.pid_controller({"forward": 1, "lateral": 0.0, "rotation": 0.0, "grasper": 1}, epsilon,
                                           self.pid_params.Kp_angle_1, self.pid_params.Kd_angle_1,
                                           self.pid_params.Ki_angle, self.past_ten_errors_angle, "rotation", 0.5)
